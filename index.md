...
aloha = LambdaFunction("Aloha", pin="true", pos="-0.25, -0.25", href="/aloha.html")
s3 = S3("Storage Bucket", pin="true", pos="0, -0.25")
...
with Cluster("Docker Compose", graph_attr={"bgcolor": "#E0F2F1"}):
    ...
    cpp_pipeline = Python("Image Processing\nPipeline", pin="true", pos="-0.875, 0", href="/pipeline.html")
    buffer = Python("Buffer\nService", pin="true", pos="-0.625, -0.25", href="/buffer.html")
    QC_service = Python("QC Service", pin="true", pos="-0.625, 0", href="/qc.html")
...
with Cluster("Platform9", graph_attr={"bgcolor": "#b2ffc7"}):
    log = Loki("Log Server", pin="true", pos="0.25, 0", href="/log.html")
    ac_qc = Python("AC/QC", pin="true", pos="0, 0")

registry = Docker("Container Registry", pin="true", pos="-0.125, 0.625", href="/registry.html")
runner = Github("GitHub Actions", pin="true", pos="0.125, 0.625", href="/runner.html")
